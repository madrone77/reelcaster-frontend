...
export const metadata: Metadata = {
  ...
  description:
    'Tides, weather, water conditions, and regulations combined into one fishing score for the BC, Washington, Oregon and California coasts. Find the best spot and the best window before you go.',
