...
// region-neutral because coverage now spans BC, Washington, Oregon and California.
//
...
export const metadata: Metadata = {
  ...
  description:
    'ReelCaster turns tides, weather, water conditions, and regulations into one fishing score, so you know when and where to fish on the BC, Washington, Oregon and California coasts.',
  ...
  openGraph: {
    ...
    description:
      'Tides, weather, water conditions, and regulations in one simple fishing score for the BC, Washington, Oregon and California coasts.',
    url: siteUrl('/'),
    type: 'website',
    ...DEFAULT_OG,
  },
...
const HOMEPAGE_JSONLD = {
  ...
  description:
    'Fishing forecasts for the BC, Washington, Oregon and California coasts: tides, weather, water conditions, and regulations combined into one simple score.',
};
