...
export const metadata: Metadata = {
  ...
  description:
    "Interactive fishing map: browse covered spots on the BC, Washington, Oregon and California coasts with live scores, conditions, and the day's best windows.",
  ...
  openGraph: {
    ...
    description:
      "Every fishing spot on the BC, Washington, Oregon and California coasts, scored hour by hour on tides, weather, water conditions, and regulations. Pick your spot, then your window.",
