 ...
 * across two countries this must take a country and every caller must be
 * given one. The route pages already pass both, deliberately, so
 * /fishing/us/bc cannot resolve.
 */
