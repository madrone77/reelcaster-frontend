...
/**
 * `/lp/nanaimo/2`: /lp/nanaimo/1's animated hero over /lp/7's live city
...
export default function LpNanaimo2() {
  return <BlendPage city={NANAIMO} ask="explore" landing="lpnanaimo2" />;
}
