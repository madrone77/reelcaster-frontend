...
/**
 * `/lp/2?city=...` — the shape ad links are generated in. Redirects to the
 * ISR-cached `/lp/2/[city]` page, carrying the attribution query with it.
 * See ../lp-entry.ts for why this is a redirect and not a render.
 */
export default async function LpVariant2Entry({
  searchParams,
}: {
  searchParams: Promise<LpSearchParams>;
}) {
  enterLp('2', await searchParams);
}
