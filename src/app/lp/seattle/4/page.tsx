...
/**
 * `/lp/seattle/4` -- /lp/seattle/1 with the second picture alive.
 *
 ...
 *
 * Counts under `lpseattle4` (city1-city.ts). See ../1 for the arm it is
...
export default function LpSeattle4() {
  return <City1Page city={SEATTLE_1} variant={4} />;
}
