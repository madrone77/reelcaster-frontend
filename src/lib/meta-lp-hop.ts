 ...
 *
 * This was a coin toss against the landing page from 2026-09-06 to 09-10
 * (`meta_lp5_explore` in src/lib/lp-splits.ts). The map won: on 4,679 evenly
 * dealt Meta hits it put 6.0% of them in front of a wall against the page's
 * 2.5%. Trials were 2 against 1, too few to decide anything, so the wall
 * rate is what called it. The split and its arm are gone and the hop is
 * unconditional again, as it was under FE #589.
 *
