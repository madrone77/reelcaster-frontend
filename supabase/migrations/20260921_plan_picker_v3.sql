-- plan_picker_v3: how to draw the plan cards, on both shapes of the trial modal.
...
-- The one-button arm is retired (Casey, 2026-09-21): every reader gets cards,
-- and with no arm assigned the code draws b. v2 (button vs cards) concludes
-- for the cards when v3 starts. Runs alone: testimonial_none_v1 concludes the
-- same day for no quote, and the quote is gone from every trial modal.
--
